...
async function fetchData() {
    // Show loading states
    document.getElementById('auth-table-body').innerHTML = '<tr><td colspan="4" class="empty-state">Loading...</td></tr>';
    document.getElementById('wifi-table-body').innerHTML = '<tr><td colspan="4" class="empty-state">Loading...</td></tr>';
...
function renderAuthTable(data) {
    ...
    if (!data || data.length === 0) {
        tbody.innerHTML = '<tr><td colspan="4" class="empty-state">No users registered yet. (Or table missing)</td></tr>';
        return;
    }
...
function renderWifiTable(data) {
    ...
    if (!data || data.length === 0) {
        tbody.innerHTML = '<tr><td colspan="4" class="empty-state">No Wi-Fi QR codes generated yet. (Or table missing)</td></tr>';
        return;
    }
